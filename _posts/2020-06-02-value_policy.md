...
A는 Value-based 방식을 따랐고, B는 Policy-based 방식을 따른 것입니다.
...
Value의 종류에는 여러 가지가 있지만 주로 State Action Q-value를 가리킵니다.

State Action Q-Value는 다음과 같이 정의할 수 있습니다.
...
> Return과 Discount Factor는 [MDP 포스트](2020-05-25-MDP.md) 를 참조
