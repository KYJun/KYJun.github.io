...
> Q-Value를 구하는 Bellman Equation ([참조](/2020-06-02-value_policy.md))
...
기계학습에 있어서 Bias와 Variance Trade-off에 대해 자세한 내용은 관련 링크를 참조하겠습니다. ([Bias-Varinace Trade-Off](http://bitly.kr/wsOCnaqH))
